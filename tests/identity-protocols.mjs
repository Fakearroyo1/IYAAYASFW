...
{const r=await login();await rejects(()=>P.finishPasskey(db,env,r.flow,r.ceremony,browser,assertion(r.options.challenge,{counter:1}),false),'nonzero counter rollback denied');}
