...
if(id!=='ed7e63c8-77fd-4314-ab35-131c061e016a')throw Error('The D1 ID differs from the established production database.');
...
for(const args of [ ['d1','execute','iyaayasfw-supply-db','--remote','--file','AUTH-SCHEMA.sql','--config',configPath], ['d1','execute','iyaayasfw-supply-db','--remote','--file','PRODUCT-SCHEMA.sql','--config',configPath], ['d1','execute','iyaayasfw-supply-db','--remote','--file','SECURITY-SCHEMA.sql','--config',configPath], ['deploy','--config',configPath] ]){
