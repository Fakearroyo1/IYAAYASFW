...
export const metadata={title:'IYAAYASFW member login | Unit Supply',description:'Your unit snack bar and member account. Sign in to IYAAYASFW Unit Supply.'};
...
export default function About(){return <div className="landing">
 ...
 <main>
  <section className="landing-hero" aria-labelledby="landing-title">
   ...
   <h1 id="landing-title">Unit snack bar.</h1>
   <p className="landing-intro">Grab a snack, pay, and get back to your day.</p>
  ...
  <section id="about" className="landing-about" aria-labelledby="about-title">
   <div className="landing-about-intro"><h2 id="about-title">About the snack bar</h2></div>
