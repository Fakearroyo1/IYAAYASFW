...
export default function Login(){
 ...
 <p className="fine">Pickup only · Access by approved email.</p>{mode==='login'?<p className="fine">Your personal device stays signed in until you sign out or your access is reset.</p>:null}</section></main>
}
