...
export function Field({label,children,...props}:{label:string;children?:React.ReactNode;[key:string]:any}){return <label className="field"><span>{label}</span>{children||<Input {...props}/>}</label>}
