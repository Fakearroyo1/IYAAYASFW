...
export function IdentityLinks({compact=false}:{compact?:boolean}){
 ...
 return links?<nav aria-label="Account access" className={compact?'identity-shortcuts':'identity-links'}><a href={links.member+'/identity'}>Linked methods</a>{!compact&&links.management&&<a href={links.management}>Members &amp; access</a>}</nav>:null;
}
