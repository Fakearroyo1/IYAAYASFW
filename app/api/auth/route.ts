...
export async function POST(request:Request){
 ...
 }catch(e){if(/constraint|unique/i.test(String(e)))return json({error:'Account access changed. Refresh and try again.'},409);return json({error:'Sign-in service is temporarily unavailable. No access was granted.'},503)}
}
